...
def render(viewpoint_camera, pc: GaussianModel, pipe, bg_color: torch.Tensor, scaling_modifier = 1.0, separate_sh = False, override_color = None):
    ...
    raster_settings = GaussianRasterizationSettings(
        ...
        sh_degree=pc.activate_sh_degree, 
    ...
    # from SHs in Python, do it. If not, then SH -> RGB conversion will be done by rasterize 
    shs = None 
    colors_precomp = None 
    if override_color is None:
        if pipe.convert_SHs_python:
            ...
            sh2rgb = eval_sh(pc.activate_sh_degree, shs_view, dir_pp_normalized) 
